...
Route::get('/add_employee', [EmpController::class, 'index'])->name('add_employee');
Route::get('/all_employee', [EmpController::class, 'view_employee'])->name('all_employee');
...
Route::get('/add_customer', [CustomerController::class, 'index'])->name('add_customer');
Route::get('/all_customer', [CustomerController::class, 'view_customer'])->name('all_customer');
